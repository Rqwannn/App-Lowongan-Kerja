...
<body>
    ...
    <div class="wrapper">
        ...
        <div class="button-group d-flex" style="flex-direction: column;">
            <button type="submit" onclick="AuthLogin()" class="btn btn-light w-100 mb-2 fw-bold">Login</button>
            <button type="submit" onclick="ToRegister()" class="btn btn-light w-100 mb-5 fw-bold">Register As Admin</button>
        </div>
